...
function MusicPlayer() {
  return (
    <div>
      <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 border-[#071630] py-3 bg-[#232A4E] rounded-xl mt-5">
        {/* Upper Part */}
        <div className="upperPart flex items-center justify-between">
          ...
          <div className="profile flex">
            ...
            <div className="detailsf flex flex-col ml-4">
              <span className="text-[1rem]">Naked</span>
              <span className="text-sm text-gray-500">James Arthur</span>
            </div>
          </div>
          <div>
            <img
        ...
        <div className="lowerPart flex items-center justify-between mt-5">
          {/* track */}
          <div className="track flex justify-between text-sm text-gray-500 flex-[3] items-center">
            <span>2:30</span>
            <img
              src={require('../img/music.png')}
              alt=""
              className="w-[14rem] mx-[3px]"
            />
            <span>4:30</span>
          </div>

          {/* Controls */}
          <div className="controls flex flex-[1] items-center justify-around ml-[5px]">
            {/* previous arrow */}
            <svg width="10.455" height="12.44" viewBox="0 0 10.455 12.442">
              <path
