...
function Search() {
  return (
    <div className="search relative h-[65rem] px-[5rem] bg-[#071630] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      {/* left side */}
      <div className="left flex-1">
        <img
          src={require('../img/backgraphics.png')}
          alt=""
          className="absolute top-[22rem] left-[-47rem] w-[100rem] z-[-1]"
        />
        <img
      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          ...
          <span className="text-sm mt-3 text-[#4D586A]">
            ...
            odio? <br /> Lorem ipsum dolor sit amet consectetur adipisicing
            elit. Tempore, quod.
